...
@Autonomous
@Disabled
public class NewBotLJ extends LinearOpMode {
...
/* Start Loop *//*
        ...
        } else if(redAllianceBlueTape){
            startX = 34;
            startY = -65;
            startHeading = Math.toRadians(180);
            drive.setPoseEstimate(new Pose2d(startX, startY, startHeading));
            TrajectorySequence RABT = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                    .forward(4.5)
                    .strafeLeft(12.5)
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                        coneTransporter.setRiseLevel(1);
                    ...
                    .build();
            drive.followTrajectorySequence(RABT);

        } else if(redAllianceRedTape){
            startX = -34;
            startY = -65;
            startHeading = Math.toRadians(180);
            drive.setPoseEstimate(new Pose2d(startX, startY, startHeading));
            TrajectorySequence RART = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                    .forward(4.5)
                    .strafeRight(12.5)
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                        coneTransporter.setRiseLevel(1);
                    ...
                    .build();
            drive.followTrajectorySequence(RART);
